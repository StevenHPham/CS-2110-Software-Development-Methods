...
class BinaryHeap
{
     ...
     *      5. Also in the loop set the element at 'ind' to the value stored in the 'child' element of the heap 
     *      (heap.get(child)) if value stored in the 'child element' is less than 'tmp'
